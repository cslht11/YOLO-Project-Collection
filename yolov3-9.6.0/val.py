...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='data/my_data.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default= r'D:\A_Python\YOLO_RAW\yolov3-9.6.0\runs\train\exp_w\weights\last.pt', help='model.pt path(s)')
